...
public class UserEditorGroupsPanelLogic : BaseNetLogic
{
    ...
    private void BuildUIGroups()
    {
        ...
        foreach (var group in groups.Children)
        {
            if (editable.Value)
            {
                var groupCheckBox = InformationModel.MakeObject<Panel>(group.BrowseName, Tata_EMS_Solution_Latest_08_03_2024.ObjectTypes.GroupCheckbox1);
            ...
            {
                var groupLabel = InformationModel.MakeObject<Panel>(group.BrowseName, Tata_EMS_Solution_Latest_08_03_2024.ObjectTypes.GroupLabel1);
